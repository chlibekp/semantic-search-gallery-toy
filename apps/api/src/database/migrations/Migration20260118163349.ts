...
export class Migration20260118163349 extends Migration {
  ...
  override async up(): Promise<void> {
    ...
    this.addSql(`create table "images" ("id" uuid not null default gen_random_uuid(), "image_url" varchar(255) not null, "ai_description" varchar(255) null, "ai_embedding" vector(512) null, constraint "images_pkey" primary key ("id"));`);
    this.addSql(`
